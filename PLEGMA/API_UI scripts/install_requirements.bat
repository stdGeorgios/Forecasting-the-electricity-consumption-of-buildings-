...
echo ====================================
echo PLEGMA Forecasting Demo Installer
echo ====================================
echo.
...
venv\Scripts\python.exe -c "import fastapi, uvicorn, pandas, numpy, sklearn, gradio, requests, joblib, matplotlib, xgboost, lightgbm; print('OK')"
if errorlevel 1 (
